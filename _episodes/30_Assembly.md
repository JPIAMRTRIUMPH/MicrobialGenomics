...
To run Flye inside Epi2me we will run Epi2me and use the bacterial genome assembly workflow. A complete manual is available here : link . Because assembly of each genome might take a while, we will a assemble two isolates per person. When the assembly has started for most people we can follow the assembly lecture (next page). 
