...
To run Flye inside Epi2me we will run Epi2me and use the bacterial genome assembly workflow. A complete manual is available on the setup page : [link](https://jpiamrtriumph.github.io/MicrobialGenomics/setup.html) . Because assembly of each genome might take a while, we will a assemble two isolates per person. When the assembly has started for most people we can follow the assembly lecture (next page). 
...
> [Google Sheets table](hhttps://docs.google.com/spreadsheets/d/1ImRY5QPblAv_LZrwCkHGQOKdyYQ4XHkvtYl9k8UNoKI/edit?gid=0#gid=0)
>
> Hint:
> ~~~
> $ grep -c
